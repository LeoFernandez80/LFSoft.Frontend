...
export class LoginContainerComponent {
  ...
  onRegister(): void {
    ...
    this._router.navigate(['register']).catch(err => {
      console.error('Navigation error to register page:', err);
      this._messagesService.addMessage('Error al navegar a la página de registro', EnumMessageType.Error);
    });
  }
}
