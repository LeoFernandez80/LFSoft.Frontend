...
import { TranslatePipe, GenericLayoutComponent, GenericMessageComponent, GenericActionsComponent, GridService, ActionService, PageFilter, MessagesService, ModalService, EnumMessageType, EnumActionsType, EnumActionsViewType, EnumActionsStyle, CONFIRM_DELETE, Action } from '@lib/shared';
...
@Component({
  ...
  providers: [Router, GridService, UrlService]
})
export class ArticlesContainerComponent implements OnInit, OnDestroy {
  ...
  private _actionNewArticle(): void {
  ...
  private _loadSecurityActions(): void {
    const actions: Action[] = [
      ...
      new Action('BUTTON.users', EnumActionsType.openUsers, EnumActionsIcons.openUsers, false, EnumActionsViewType.view16x16),
      new Action('BUTTON.logout', EnumActionsType.actionLogout, EnumActionsIcons.actionLogout, false, EnumActionsViewType.view16x16)
    ];
