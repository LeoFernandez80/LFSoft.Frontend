...
@Component({
  ...
  providers: [] // IMPORTANTE: NO incluir ActionService en providers
})
```

**IMPORTANTE**: Si el componente ya tiene `ActionService` en el array de `providers`, debe **QUITARSE**. La floating toolbar requiere que ActionService sea manejado de forma global, no a nivel de componente individual.
...
private _loadSecurityActions(): void {
  const actions: Action[] = [
    new Action(
      ...
      EnumActionsIcons.openHome,                            // Material icon
